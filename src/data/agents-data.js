...
var AGENTS=[
 ...
 /* The nurse arrives at the treatment bay while the patient is paused there. */
 {role:'nurse',    L:buildLoop([[23,4],[23,7],[7,7],[7,13]], {0:2.6,3:3.2}, SPEED), heartIdx:3, heartAt:[7,14], startAt:10.45},
